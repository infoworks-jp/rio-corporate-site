(() => {
  ...
  <div class="credential-group"><div class="credential-kicker">COMPANY LICENSE / 会社許可・登録</div><article class="credential-item"><h3>建設業許可</h3><p>北海道知事許可（般-25）石第21656号</p><span class="credential-view">TEXT RECORD</span></article><article class="credential-item"><h3>産業廃棄物収集運搬業許可</h3><a class="credential-view" href="assets/certificates/original/industrial-waste-transport-permit.png" target="_blank" rel="noopener noreferrer">産業廃棄物収集運搬業許可証を開く ↗</a></article></div>
